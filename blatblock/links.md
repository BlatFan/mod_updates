...
- 🎯 JEI Integration - Full recipe and information integration
...
![Json](https://github.com/BlatFan/BlatBlock/blob/master/img/json.png?raw=true)
...
# 🎮 Gameplay Tips
## Early Game Strategy
Start Mining: Use the generator to collect basic materials
Craft Tools: Create multitools for efficient resource gathering
Build Platform: Expand your starting area for safety
Progress Layers: Collect enough blocks to unlock new tiers
...
LevelEvents.loaded(event => {
    BBLRegistry.removeAll()
    BBLRegistry.add('blatblock:test')
        .title('The Test Layer')
        .titleColor('#dce775')
        .texture('blatblock:textures/gui/end.png')
        .background('blatblock:textures/gui/end_bg.png')
        .blockCost(2000)
        ...
        .register()
    BBLRegistry.remove('blatblock:end')
})
```
